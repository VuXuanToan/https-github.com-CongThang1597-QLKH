...
AS
BEGIN
	INSERT INTO PHIEUNHAPKHO VALUES (@MAPN, @MAKHO, @MANCC, @NVNHAP, @NGAYNHAP, @GHICHU)
	INSERT INTO CHITIETPHIEUNHAP VALUES (@MAPN, @MASP, @SOLUONG, @TONGTIEN)
END
GO
